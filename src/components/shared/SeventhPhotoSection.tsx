import seventhPhoto from '@/assets/gallery/seventh-section.webp';
import seventhPhotoMobile from '@/assets/gallery/seventh-section-mobile.webp';
import FadeInImage from './FadeInImage';

export default function SeventhPhotoSection() {
  return (
    <div className="relative w-full h-[55vh] md:h-[70vh] lg:h-[85vh] overflow-hidden">
      <picture>
        <source media="(min-width: 1280px)" srcSet={seventhPhoto} />
        <FadeInImage
          src={seventhPhotoMobile}
          loading="lazy"
          decoding="async"
