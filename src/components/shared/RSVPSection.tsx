    ...
    return (
      ...
      >
        <div className="bg-wedding-cream border border-wedding-gold/20 rounded-3xl p-6 md:p-12 mx-4 max-w-lg md:mx-auto shadow-xl">
          ...
          <h2 className="text-3xl font-anaktoria mb-4 text-wedding-dark">Maraming salamat!</h2>
          <p className="font-anaktoria italic text-lg text-wedding-dark/60 whitespace-pre-line">
            {successMessage}
          </p>
        </div>
      </motion.div>
                ...
                {guests.map((guest) => (
                  <div key={guest.id} className="p-6 md:p-8 border border-wedding-gold/5 rounded-3xl bg-white/40 space-y-6 hover:border-wedding-gold/20 transition-all shadow-sm">
                    <div className="flex flex-col items-center md:flex-row md:items-center justify-between gap-4">
                      <span className="font-anaktoria text-xl md:text-2xl text-wedding-dark text-center md:text-left">{guest.name}</span>
              ...
              {!isPastDeadline && (
                <div className="pt-8 space-y-8">
                  ...
                  <Button
                    ...
                    className="w-full bg-wedding-dark hover:bg-wedding-dark/95 text-white rounded-full py-7 md:py-9 text-lg md:text-xl font-anaktoria tracking-[0.2em] transition-all shadow-xl disabled:opacity-20 active:scale-95"
                  >
