import secondPhotoDesktop from '@/assets/gallery/second-section-desktop.webp';
import secondPhotoMobile from '@/assets/gallery/second-section-mobile.webp';

export default function SecondPhotoSection() {
  return (
    <div className="relative w-full h-[55vh] md:h-[70vh] lg:h-[85vh] overflow-hidden">
      <picture>
        <source media="(min-width: 1280px)" srcSet={secondPhotoDesktop} />
        <img
          src={secondPhotoMobile}
          loading="lazy"
          decoding="async"
