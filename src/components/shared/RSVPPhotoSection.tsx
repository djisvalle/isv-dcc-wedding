import rsvpPhoto from '@/assets/gallery/rsvp-section.webp';
import rsvpPhotoMobile from '@/assets/gallery/rsvp-section-mobile.webp';
import FadeInImage from './FadeInImage';

export default function RSVPPhotoSection() {
  return (
    <div className="relative w-full h-[55vh] md:h-[70vh] lg:h-[85vh] overflow-hidden">
      <picture>
        <source media="(min-width: 1280px)" srcSet={rsvpPhoto} />
        <FadeInImage
          src={rsvpPhotoMobile}
          loading="lazy"
          decoding="async"
