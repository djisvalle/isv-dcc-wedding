    ...
    <section className="relative overflow-hidden">
      ...
      >
        ...
        <div className="relative w-full md:w-[32vw] lg:w-auto md:rounded-2xl md:border md:border-wedding-gold/10 md:shadow-md md:overflow-hidden">
          ...
          />
          <div className="absolute inset-x-0 top-0 h-20 bg-[linear-gradient(to_bottom,#FDFBF7_0%,rgba(253,251,247,0.7)_20%,rgba(253,251,247,0.35)_45%,rgba(253,251,247,0.12)_70%,transparent_100%)] md:hidden pointer-events-none" />
          <div className="absolute inset-x-0 bottom-0 h-20 bg-[linear-gradient(to_top,#FDFBF7_0%,rgba(253,251,247,0.7)_20%,rgba(253,251,247,0.35)_45%,rgba(253,251,247,0.12)_70%,transparent_100%)] md:hidden pointer-events-none" />
